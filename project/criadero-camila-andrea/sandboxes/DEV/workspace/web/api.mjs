let token = localStorage.getItem("cca_session_token") || null;
let serverAvailable = false;

export function getToken() { return token; }
export function setToken(t) { token = t; if (t) localStorage.setItem("cca_session_token", t); else localStorage.removeItem("cca_session_token"); }
...
export async function request(method, path, body = null) {
  ...
  if (res.status === 401) { setToken(null); serverAvailable = false; return { error: { code: "auth", message: "Sesion expirada" } }; }
  return json;
}
