...
export const STATUS_LABELS = {
  active: "Activo",
  inactive: "Inactivo",
  temporary_out: "Fuera temporal",
  in_treatment: "En tratamiento",
  sold: "Vendido",
  retired: "Retirado",
  deceased: "Fallecido",
  in_stay: "En pension",
  out_of_stay: "Fuera de pension",
...
export const MODULES = [
  ...
  },
  {
    ...
    permission: "horses.manage",
    fields: [
      { name: "ownershipType", label: "Tipo", type: "select", options: ["own", "boarded"], required: true },
      ...
      { name: "clientId", label: "Dueno cliente", type: "relation", collection: "clients", display: "fullName" },
      ...
      { name: "fatherHorseId", label: "Padre registrado", type: "relation", collection: "horses", display: "name" },
      { name: "fatherExternalName", label: "Padre externo", type: "text" },
      { name: "motherHorseId", label: "Madre registrada", type: "relation", collection: "horses", display: "name" },
  ...
  },
  {
    ...
    label: "Pensiones",
    singular: "pension",
    endpoint: "/api/v1/boarding-stays",
    permission: "boarding_stays.manage",
    fields: [
      { name: "horseId", label: "Caballo pensionado", type: "relation", collection: "horses", display: "name", filter: { ownershipType: "boarded" }, required: true },
      ...
      { name: "boardingType", label: "Tipo pension", type: "select", options: ["client_supplies", "included_supplies", "mixed", "other"], required: true },
      { name: "otherTypeDescription", label: "Descripcion otro tipo", type: "text" },
      ...
      { name: "otherSupplies", label: "Otros insumos", type: "textarea" },
      { name: "careNotes", label: "Notas de cuidado", type: "textarea" }
    ],
  ...
  },
  {
    ...
    label: "Pagos",
    singular: "pago",
    endpoint: "/api/v1/boarding-payments",
    permission: "boarding_payments.manage",
    fields: [
      { name: "boardingStayId", label: "Pension", type: "relation", collection: "boardingStays", display: "code", required: true },
      { name: "paymentDate", label: "Fecha pago", type: "date", required: true },
      { name: "paidMonths", label: "Meses pagados", type: "text", required: true, placeholder: "2026-06, 2026-07" },
      { name: "paymentMethod", label: "Medio", type: "select", options: ["cash", "transfer"], required: true },
  ...
  },
  {
    ...
    permission: "vaccinations.manage",
    fields: [
      { name: "horseId", label: "Caballo", type: "relation", collection: "horses", display: "name", required: true },
      { name: "vaccineName", label: "Vacuna", type: "text", required: true },
  ...
  },
  {
    ...
    label: "Herrajes",
    singular: "herraje",
    endpoint: "/api/v1/farrier-records",
    permission: "farrier_records.manage",
    fields: [
      { name: "horseId", label: "Caballo", type: "relation", collection: "horses", display: "name", required: true },
      { name: "serviceDate", label: "Fecha", type: "date", required: true },
      { name: "serviceType", label: "Tipo servicio", type: "select", options: ["trim", "shoeing", "correction", "other"], required: true },
  ...
  },
  {
    id: "documentBatches",
    label: "Documentos",
    singular: "lote documental",
    endpoint: "/api/v1/document-batches",
    ...
    fields: [
      ...
      { name: "filesText", label: "Archivos", type: "textarea", required: true, placeholder: "pedigree.pdf\nfoto-llegada.jpg" }
    ],
    defaults: { status: "active" }
  },
  {
    ...
    fields: [
      ...
      { name: "role", label: "Rol", type: "select", options: ["owner", "admin"], required: true }
    ],
  ...
  },
  {
    ...
    permission: "admin_invitations.manage",
    fields: [
      { name: "email", label: "Correo invitado", type: "email", required: true },
      { name: "role", label: "Rol", type: "select", options: ["admin"], required: true },
